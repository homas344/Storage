...
public abstract class PaginatedMenu {
    ...
    public void openPaginatedInventory(Player player, int page, List<Map<String, String>> storedItems) {
    ...
    private void populateInventoryWithItems(Inventory inventory, List<Map<String, String>> storedItems,
        ...
        for (int i = startIndex; i < endIndex; i++) {
            ...
            Map<String, String> row = storedItems.get(i);
            ItemStack item = createItemFromStoredData(row);

            inventory.setItem(slot++, item);
        }
    }

    private ItemStack createItemFromStoredData(Map<String, String> row) {
        String encodedObject = row.get("item_value");
        String playerName = row.get("player_name");
